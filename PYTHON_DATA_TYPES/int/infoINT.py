...
# with the help of id we can get the memory address of the variable.
print(id(a))
# output ---> 2459755327952 
#             (this is the the memory address will change every time, variable address will be different.

# we can check output of int, their type and their address in one line 
sno = 579
print(sno, type(sno), id(sno)) 
# output ---> 579 <class 'int'> 2279818976304
# -----------------------------------------------------------------------------------------
# int is NOT keyword in python, int is class, we can use class name as variable name in python
int = 2345
print(int, type(int), id(int))   
# output ---> 2345 <class 'int'> 2652633160624
# -----------------------------------------------------
#  Decimal Number System
# -----------------------------------------------------
# above are the example for decimal 
# -----------------------------------------------------
#  Binary Number System
# -----------------------------------------------------
# syntax
binarynum = 0b1101 #-----> binary number
print(binarynum, type(binarynum))
